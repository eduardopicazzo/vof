...
- Unless it's a completely new file, default to providing the relevant code changes only along with surrounding contexts of where to place the changes at (can be file paths or line numbers or a surrounding context itself)
