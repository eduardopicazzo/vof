...
├── .cursorrules.md                # Plugin development rules and guidelines
├── .gitignore                     # Git ignore rules
├── assets/
│   └── js/
│       ├── txt-files-maybe-reuse/ # Reference JavaScript files
│       │   ├── vof-form-validation.txt
│       │   ├── vof-gallery-extension.txt
│       │   └── vof-listing-submit.txt
│       └── vof-listing-submit.js  # Active listing submission handler
├── composer.json                  # Composer package definition
├── composer.lock                  # Composer dependency lock file
├── includes/
│   ├── class-vof-assets.php      # Asset management
│   ├── class-vof-constants.php   # Plugin constants
│   ├── class-vof-core.php        # Core plugin functionality
│   ├── class-vof-dependencies.php # Plugin dependencies checker
│   ├── class-vof-form-handler.php # Form processing
│   └── class-vof-listing.php     # Listing management
├── templates/
│   └── listing-form/
│       └── vof-contact.php       # Contact form template
├── utils/
│   ├── vof-stripe/
│   └── helpers/
│       ├── class-vof-helper-functions.php # Helper functions
│       └── class-vof-temp-user-meta.php   # Temporary user data handling
